    ...
    <section className="relative pt-32 pb-24 md:pt-40 md:pb-32 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="bg-gradient-to-r from-secondary/10 to-primary/10 p-8 rounded-2xl mb-8 animate-fade-in" style={{ animationDelay: '0.3s' }}>
            ...
            <div className="text-center">
              ...
              <Button 
                ...
                size="lg" 
                className="text-xl flex gap-2 py-8 px-12 rounded-full shadow-lg bg-secondary hover:bg-secondary/90 transform hover:scale-105 transition-all"
              >
