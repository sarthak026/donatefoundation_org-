...
const Hero: React.FC = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      {/* Single Background Image - No Overlap */}
      ...
      {/* Decorative gradient shapes - non-overlapping */}
      <div className="absolute top-20 left-20 w-32 h-32 bg-gradient-to-br from-primary/20 to-secondary/20 rounded-full blur-2xl z-5 hidden lg:block"></div>
      <div className="absolute bottom-32 right-20 w-24 h-24 bg-gradient-to-tl from-secondary/15 to-primary/15 rounded-full blur-xl z-5 hidden lg:block"></div>
